...
namespace WindowsFormsApp2 {
    ...
    public partial class loginDBDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(int Id, string _e_mail, string password) {
...
namespace WindowsFormsApp2.loginDBDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@p3 = 1 AND [e-mail]" +
                " IS NULL) OR ([e-mail] = @p2)) AND ((@IsNull_password = 1 AND [password] IS NULL" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [e-mail], [password]) VALUES (@Id, @p1, @passwor" +
                "d);\r\nSELECT Id, [e-mail], password FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [e-mail] = @p1, [password] = @password WHERE (([Id] = @Original_Id) AND ((@p3 = 1 AND [e-mail] IS NULL) OR ([e-mail] = @p2)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)));
SELECT Id, [e-mail], password FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp2.Properties.Settings.Default.loginDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, [e-mail], password FROM dbo.[Table]";
        ...
        public virtual int Fill(loginDBDataSet.TableDataTable dataTable) {
        ...
        public virtual loginDBDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            loginDBDataSet.TableDataTable dataTable = new loginDBDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(loginDBDataSet.TableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string p2, string Original_password) {
        ...
        public virtual int Insert(int Id, string p1, string password) {
        ...
        public virtual int Update(int Id, string p1, string password, int Original_Id, string p2, string Original_password) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string p1, string password, int Original_Id, string p2, string Original_password) {
            return this.Update(Original_Id, p1, password, Original_Id, p2, Original_password);
        }
    }
